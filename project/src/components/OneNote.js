...
deleteQuerry = () => {
if(this.props.note.poster===this.props.loggedIn){this.deleteToggle()}
...
editQuerry = () => {
if(this.props.note.poster===this.props.loggedIn){this.props.editNote(this.props.index)}
...
{this.state.deleting ? (
<Modal deleteNote={this.props.deleteNote} deleteToggle={this.deleteToggle} token={this.props.token} id={this.props.note.id} />
):(
null	
)
}
