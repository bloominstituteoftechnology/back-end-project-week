...
submitQuerry = (e) => {
e.preventDefault();
if(this.state.title&&this.state.contents){this.props.createNote(this.props.loggedIn,this.state.title,this.state.contents,this.props.token);}
else{alert('Need a title and contents!')}
}

editQuerry = (e) => {
e.preventDefault();
if(this.state.title&&this.state.contents){this.props.edit(this.props.notes[0].id,this.state.title,this.state.contents,this.props.token);}
else{alert('Need a title and contents!')}
}
