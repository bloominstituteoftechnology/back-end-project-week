        ...
        it("should get a list of all users from the DB", done => {
            chai
                ...
                .end((err, response) => {
                    ...
                    expect(response.body[0].username).to.equal(getUserInfo.username.toLowerCase());
                    ...
                    expect(response.body[0].contactInfo).to.deep.equal(getUserInfo.contactInfo);
        ...
        it("should save document to the DB", done => {
            chai
                ...
                .end((err, response) => {
                    ...
                    expect(response.body.username).to.equal(postUserInfo.username.toLowerCase());
                    ...
                    expect(response.body.contactInfo).to.deep.equal(postUserInfo.contactInfo);
